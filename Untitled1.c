...
int main() { /* almacena la cantidad de discos ingresada */
    ...
    if (cantDiscos > 35) {
        printf("\n\nPor favor, ingrese 35 discos o menos para su correcto funcionamiento\n\n\n");
        system("PAUSE");
        return 0;
        /* Comprueba que la cantidad de discos no supere 25 */
    }
    ...
    /* Llama a la función "moverDiscos" */
    /* La función recibe como datos:
...
void moverDiscos(int n, int origen, int destino, int aux) {
    ...
    if (n > 0) {
        ...
        /* Paso 2: Mueve el disco más grande de la torre origen a la torre destino */
